...
(function () {
  ...
  function cmpBy(k, a, b) {
    ...
    if (k === "total") return (a.total || 0) - (b.total || 0);
    return 0;
  }
  ...
  function renderTable() {
    ...
    var cols = showDetails
      ? [["name", "이름"], [null, "연락처<br>(010-)"], ["date", "날짜"], ["time", "시간"], ["total", "총인원<br>(성인/아동)"], [null, "비고"]]
      : [["name", "이름"], ["date", "날짜"], ["time", "시간"], ["total", "총인원"]];
