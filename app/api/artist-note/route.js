...
작가 노트
(43개 답변을 모두 반영해 4~6문단, 각 2~4문장으로 씁니다. 지금의 나와 이 프로젝트에 오게 된 자리에서 시작해, 흙을 처음 만진 시간, 내 모뉴먼트, 함께 만든 대형 울림통, 그리고 지금 돌아보는 마음으로 자연스럽게 흘러가게 씁니다. 모든 답을 한 번씩 나열하려 하지 말고, 서로 가까운 답변을 묶어 글의 흐름을 만듭니다. 문단마다 소제목을 달지 않습니다.)
