  ...
  return (
    <div className="workbench">
      <style>{`
        ...
        .wb-chip { display:inline-block; padding:7px 15px; border:1px solid #e3d3c7; border-radius:16px; background:transparent; color:#96786a; cursor:pointer; font:400 13px 'Noto Sans KR', sans-serif; line-height:1.5; transition:color .15s,border-color .15s,background .15s; }
        .wb-chip:hover { border-color:#c0a492; color:var(--an-text); }
        .wb-chip.is-on { border-color:#261410; background:#ece0d5; color:#261410; font-weight:700; }
        .wb-input { width:100%; max-width:520px; padding:7px 15px; border:1px solid #e3d3c7; border-radius:16px; background:transparent; color:#261410; font:400 13px 'Noto Sans KR', sans-serif; line-height:1.5; transition:color .15s,border-color .15s,background .15s; }
        .wb-input:hover { border-color:#c0a492; }
        .wb-input:focus { border-color:#261410; outline:none; }
        .wb-input::placeholder { color:#96786a; font-weight:400; }
        .wb-input.is-on { border-color:#261410; background:#ece0d5; font-weight:700; }
